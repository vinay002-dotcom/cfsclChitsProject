...
public class CommandWrapperBuilder {
    ...
    public CommandWrapperBuilder createChitGroup() {
        this.actionName = "CREATE";
        this.entityName = "CHITGROUP";
        this.entityId = null;
        this.href = "/chitgroup/template";
        return this;
    }
    public CommandWrapperBuilder updateChitGroup(final Long id) {
        this.actionName = "UPDATE";
        this.entityName = "CHITGROUP";
        this.entityId = id;
        this.href = "/chitgroup/" + id;
        return this;
    }
    
    public CommandWrapperBuilder activateChitGroup(final Long chitGroupId) {
        this.actionName = "ACTIVATE";
        this.entityName = "CHITGROUP";
        this.entityId = chitGroupId;
        this.groupId = chitGroupId;
        this.href = "/chitgroup/" + chitGroupId + "?command=activate";
        return this;
    }

    public CommandWrapperBuilder createChitBids() {
        this.actionName = "CREATE";
        this.entityName = "CHITGROUPBID";
        this.entityId = null;
        this.href = "/chitgroup/{id}/bids";
        return this;
    }
    public CommandWrapperBuilder updateChitBids(final Long id) {
        this.actionName = "UPDATE";
        this.entityName = "CHITGROUPBID";
        this.entityId = id;
        this.href = "/chitgroup/{id}/bids" + id;
        return this;
    }
    public CommandWrapperBuilder deleteChitBids(final Long id) {
        this.actionName = "DELETE";
        this.entityName = "CHITGROUPBID";
        this.entityId = id;
        this.href = "/chitgroup/{id}/bids" + id;
    ...
    public CommandWrapperBuilder createClientTranChitAdvance(final Long clientId) {
        this.actionName = "CREATE";
        this.entityName = ClientApiConstants.CLIENT_TRANSACTION_ACTION_CREATE_CHITADV;
        this.entityId = clientId;
        this.clientId = clientId;
        this.href = "/clients/" + clientId + "/transactions?command=chit_advance";
        return this;
    }
