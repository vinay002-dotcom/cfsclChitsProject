...
final class ClientAddressApiResourcesSwagger {
    ...
    public static final class PostClientClientIdAddressesRequest {
        ...
        @Schema(example = "No 434")
        public String houseNo;
        @Schema(example = "17 Cross")
        public String street;
        @Schema(example = "=Area like SaiLayout")
        public String addressLine1;
        @Schema(example = "=Landmark like Near TotalMall")
        public String addressLine2;
        @Schema(example = "charkop")
        public String addressLine3;
        @Schema(example = "Amrutahalli")
