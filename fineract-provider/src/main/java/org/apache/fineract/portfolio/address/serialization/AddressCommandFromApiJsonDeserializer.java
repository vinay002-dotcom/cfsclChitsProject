...
public class AddressCommandFromApiJsonDeserializer {
    ...
    public void validate(final String json, final boolean fromNewClient) {
        ...
        if (fromNewClient) {
            ...
            supportedParameters.add("districtName");
            supportedParameters.add("TalukaName");
            supportedParameters.add("LandMark");
...
//        final String TalukaName = this.fromApiJsonHelper.extractStringNamed("TalukaName", element);
//        if (enabledFieldsMap.get("TalukaName")) {
//            if (madatoryFieldsMap.get("TalukaName") && fromNewClient) {
//                baseDataValidator.reset().parameter("TalukaName").value(TalukaName).notBlank();
//            }
//            if (!regexFieldsMap.get("TalukaName").isEmpty()) {
//                baseDataValidator.reset().parameter("TalukaName").value(TalukaName)
//                        .matchesRegularExpression(regexFieldsMap.get("TalukaName"));
//            }
//        }
//        
//        final String districtName = this.fromApiJsonHelper.extractStringNamed("districtName", element);
//        if (enabledFieldsMap.get("districtName")) {
//            if (madatoryFieldsMap.get("districtName") && fromNewClient) {
//                baseDataValidator.reset().parameter("districtName").value(districtName).notBlank();
//            }
//            if (!regexFieldsMap.get("districtName").isEmpty()) {
//                baseDataValidator.reset().parameter("districtName").value(districtName)
//                        .matchesRegularExpression(regexFieldsMap.get("districtName"));
//            }
//        }
//        
//        
//        final String LandMark = this.fromApiJsonHelper.extractStringNamed("LandMark", element);
//        if (enabledFieldsMap.get("LandMark")) {
//            if (madatoryFieldsMap.get("LandMark") && fromNewClient) {
//                baseDataValidator.reset().parameter("LandMark").value(LandMark).notBlank();
//            }
//            if (!regexFieldsMap.get("LandMark").isEmpty()) {
//                baseDataValidator.reset().parameter("LandMark").value(LandMark)
//                        .matchesRegularExpression(regexFieldsMap.get("LandMark"));
//            }
//        }
