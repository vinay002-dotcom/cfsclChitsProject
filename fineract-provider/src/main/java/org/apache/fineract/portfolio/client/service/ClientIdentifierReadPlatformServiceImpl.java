...
public class ClientIdentifierReadPlatformServiceImpl implements ClientIdentifierReadPlatformService {
    ...
    private static final class ClientIdentityMapper implements RowMapper<ClientIdentifierData> {
        ...
        public String schema() {
            return "ci.id as id, ci.client_id as clientId, ci.document_type_id as documentTypeId, ci.status as status, ci.document_key as documentKey,ci.is_digiverified as isdigiverified, ci.lastmodified_date as lastmodifieddate,"
        ...
        public ClientIdentifierData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            final Boolean isdigiverified = rs.getBoolean("isdigiverified");
            final ZonedDateTime lastmodifieddate = JdbcSupport.getDateTime(rs, "lastmodifieddate"); 
            return ClientIdentifierData.singleItem(id, clientId, documentType, documentKey, status, description,isdigiverified,lastmodifieddate.toLocalDateTime());
        }
