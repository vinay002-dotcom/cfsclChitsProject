...
@Table(name = "m_client_identifier", uniqueConstraints = {
        @UniqueConstraint(columnNames = { "document_type_id" }, name = "unique_identifier_key"),
        @UniqueConstraint(columnNames = { "client_id" }, name = "unique_active_client_identifier") })
public class ClientIdentifier extends AbstractAuditableCustom {
    ...
    @Column(name = "is_digiverified" )
    private Boolean isdigiverified;
    ...
    public static ClientIdentifier fromJson(final Client client, final CodeValue documentType, final JsonCommand command) {
        ...
        final Boolean isdigiverified = command.booleanObjectValueOfParameterNamed("isdigiverified");
        return new ClientIdentifier(client, documentType, documentKey, status, description,isdigiverified);
    }
    ...
    private ClientIdentifier(final Client client, final CodeValue documentType, final String documentKey, final String statusName,
            String description,final Boolean isdigiverified) {
        this.client = client;
        this.documentType = documentType;
        this.documentKey = StringUtils.defaultIfEmpty(documentKey, null);
        this.description = StringUtils.defaultIfEmpty(description, null);
        this.isdigiverified =  BooleanUtils.toBooleanDefaultIfNull(isdigiverified, false);
    ...
    public Map<String, Object> update(final JsonCommand command) {
        ...
        final String isdigiverifiedParamName = "isdigiverified";
        if(command.isChangeInBooleanParameterNamed(isdigiverifiedParamName, this.isdigiverified)) {
        	final Boolean newValue = command.booleanPrimitiveValueOfParameterNamed(isdigiverifiedParamName);
        	actualChanges.put(isdigiverifiedParamName, newValue);
        	this.isdigiverified = BooleanUtils.toBooleanDefaultIfNull(newValue, false);
        }
	...
	public void setIsdigiverified(Boolean isdigiverified) {
