...
public class PaymentTypeApiResource {
    ...
    public String getAllPaymentTypes(@Context final UriInfo uriInfo) {
    	...
    	permissions.add("READ_PAYMENTTYPE");
    	this.securityContext.authenticatedUser().validateHasPermissionTo("PAYMENTTYPE", permissions);
    ...
    public String retrieveOnePaymentType(@PathParam("paymentTypeId") @Parameter(description = "paymentTypeId") final Long paymentTypeId,
        ...
        Boolean flag = this.securityContext.authenticatedUser().hasSpecificPermissionTo("READ_PAYMENTTYPE");
        if(flag)
        {
        ...
        {
        	  throw new NoAuthorizationException("Dont Do extra Work Please");
        }
