...
public interface PaymentDetailWritePlatformService {
	...
	PaymentDetail createAndPersistPaymentDetailJson(JsonObject command, Map<String, Object> changes);

	PaymentDetail createPaymentDetailJson(JsonObject command, Map<String, Object> changes);
}
