...
public final class ClientIdentifierCommandFromApiJsonDeserializer extends AbstractFromApiJsonDeserializer<ClientIdentifierCommand> {
     ...
     */
    private final Set<String> supportedParameters = new HashSet<>(Arrays.asList("documentTypeId", "documentKey", "status", "description","isdigiverified"));
    ...
    public ClientIdentifierCommand commandFromApiJson(final String json) {
        ...
        final Boolean isdigiverified = this.fromApiJsonHelper.extractBooleanNamed("isdigiverified", element);
        return new ClientIdentifierCommand(documentTypeId, documentKey, statusString, documentDescription,isdigiverified);
    }
}
