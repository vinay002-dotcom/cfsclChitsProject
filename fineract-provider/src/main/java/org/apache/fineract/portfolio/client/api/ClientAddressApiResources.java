...
public class ClientAddressApiResources {
    ...
    private final Set<String> responseDataParameters = new HashSet<>(Arrays.asList("addressId", "houseNo", "street", "addressLine1", "addressLine2",
            "addressLine3", "townVillage", "city", "countyDistrict", "talukaId", "districtId", "stateProvinceId", "countryId", "postalCode", "latitude", "longitude",
