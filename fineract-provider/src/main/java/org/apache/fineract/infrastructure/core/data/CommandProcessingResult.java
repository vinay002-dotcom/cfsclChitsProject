...
public class CommandProcessingResult implements Serializable {
    ...
    public String tooString() {
        ...
        return "this.commandId " + this.commandId +  "this.officeId " + this.officeId + "this.clientId " + this.clientId + "this.groupId " + this.groupId +
         "this.loanId " + this.loanId + "this.savingsId " + this.savingsId + "this.resourceId " + this.resourceId +
         "this.subResourceId " + this.subResourceId + "this.transactionId " + this.transactionId + "this.resourceIdentifier " + this.resourceIdentifier;
    }
