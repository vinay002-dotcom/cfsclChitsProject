...
public final class SearchParameters {
    ...
    public static SearchParameters forClients(final String sqlSearch, final Long officeId, final String externalId,
            ...
            final boolean isSelfUser,final Long staffId) {
    ...
    public static SearchParameters forChitGroups(final Long officeId, final Long staffId, final String status, final String name,
            final Integer offset, final Integer limit, final String orderBy, final String sortOrder) {

        final Integer maxLimitAllowed = getCheckedLimit(limit);
        return new SearchParameters(officeId, staffId, name, status, offset, maxLimitAllowed, orderBy, sortOrder);
    }
    ...
    public SearchParameters(final Long officeId, final Long staffId, final String name, final String status,
            final Integer offset, final Integer limit, final String orderBy, final String sortOrder) {
            this.sqlSearch = null;
            this.officeId = officeId;
            this.externalId = null;
    ...
    public SearchParameters(final Integer offset, final Integer limit, final String orderBy, final String sortOrder) {
            this.sqlSearch = null;
            this.officeId = null;
            this.externalId = null;
            this.name = null;
    ...
    public static SearchParameters forVoucher(final Integer offset, final Integer limit, final String orderBy, final String sortOrder) {
    	
    	 final Integer maxLimitAllowed = getCheckedLimit(limit);
    	return new SearchParameters(offset, maxLimitAllowed, orderBy, sortOrder);
    }
}
