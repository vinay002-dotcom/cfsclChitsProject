...
public enum PortfolioProductType {
    ...
    LOAN(1, "productType.loan"), SAVING(2, "productType.saving"), CLIENT(5, "productType.client"), PROVISIONING(3,
            "productType.provisioning"), SHARES(4, "productType.shares"), CHIT(6, "productType.chit");
    ...
    public boolean isChitProduct() {
        return this.value.equals(PortfolioProductType.CHIT.getValue());
    }
}
