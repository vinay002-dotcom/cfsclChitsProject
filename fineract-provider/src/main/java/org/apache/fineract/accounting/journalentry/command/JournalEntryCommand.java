...
public class JournalEntryCommand {
    ...
    public JournalEntryCommand(final Long officeId, final String currencyCode, final LocalDate transactionDate, final String comments,
            ...
            final Integer voucherTypeId,final String voucherNumber,final String vendorName) {
    ...
    public void validateForCreate() {
        ...
        baseDataValidator.reset().parameter("voucherTypeId").value(this.voucherTypeId).notNull().integerGreaterThanZero();
        baseDataValidator.reset().parameter("voucherNumber").value(this.voucherNumber).ignoreIfNull().notExceedingLengthOf(500);
        baseDataValidator.reset().parameter("vendorName").value(this.vendorName).ignoreIfNull().notExceedingLengthOf(500);
