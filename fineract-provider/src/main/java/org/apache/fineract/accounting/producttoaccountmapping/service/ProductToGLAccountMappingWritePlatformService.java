...
public interface ProductToGLAccountMappingWritePlatformService {
    ...
    void createChitProductToGLAccountMapping(Long chitProductId, JsonElement command);
    Map<String, Object> updateChitProductToGLAccountMapping(Long chitProductId, JsonElement command);
