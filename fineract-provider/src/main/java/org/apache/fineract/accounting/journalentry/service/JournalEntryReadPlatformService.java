...
public interface JournalEntryReadPlatformService {
    ...
    Collection<JournalEntryData> rertriveEntriesUsingTransactions(Long transactionId);
    
    JournalEntryData retrieveJournalEntriesByChitSubIdandAccountId(Long accountId, Long chitGroupSubscriber);
}
