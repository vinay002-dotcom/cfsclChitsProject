...
//    @GET
//    @Path("/{productId}/{productType}/{finanicalAccountType}")
//    @Consumes({ MediaType.APPLICATION_JSON })
//    @Produces({ MediaType.APPLICATION_JSON })
//    public Map<String, Object> getProductAccountMappingData(@PathParam("productId") final Long productId, 
//    		@PathParam("productType") final Long productType,
//    		@PathParam("finanicalAccountType") final Long finanicalAccountType) {   	
//				return glAccountChitReadPlatformService.getProductAccountMappingData(productId, productType, finanicalAccountType);
//    }
    
    @POST
    @Path("/{clientId}/{currencyCode}/{accountId}/{transactionId}/{tranDate}/{amount}/{chitTransaction}")
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    public void createCreditJournalEntry(@PathParam("clientId")final Long clientId,
    		@PathParam("currencyCode")final String currencyCode,@PathParam("accountId")final Long accountId,
    		@PathParam("transactionId")final Long transactionId,@PathParam("transactionDate")final String tranDate,
    		@PathParam("amount")final BigDecimal amount,@PathParam("transactionId")final Long chitTransaction) {
    
    	LocalDate transactionDate = LocalDate.parse(tranDate);
    	glAccountChitWritePlatformService.createCreditJournalEntry(clientId, currencyCode, accountId, transactionId, transactionDate, amount, chitTransaction,null);
