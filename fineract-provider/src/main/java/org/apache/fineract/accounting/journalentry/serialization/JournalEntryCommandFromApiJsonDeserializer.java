...
public final class JournalEntryCommandFromApiJsonDeserializer extends AbstractFromApiJsonDeserializer<JournalEntryCommand> {
    ...
    public JournalEntryCommand commandFromApiJson(final String json) {
        ...
        final Integer voucherTypeId = this.fromApiJsonHelper.extractIntegerNamed(JournalEntryJsonInputParams.VOUCHERTYPE_ID.getValue(), element, locale);
        final String voucherNumber =this.fromApiJsonHelper.extractStringNamed(JournalEntryJsonInputParams.VOCHER_NUMBER.getValue(), element);
        final String vendorName = this.fromApiJsonHelper.extractStringNamed(JournalEntryJsonInputParams.VENDOR_NAME.getValue(), element);
        ...
        return new JournalEntryCommand(officeId, currencyCode, transactionDate, comments, credits, debits, referenceNumber,
                ...
                voucherTypeId,voucherNumber,vendorName);
    }
