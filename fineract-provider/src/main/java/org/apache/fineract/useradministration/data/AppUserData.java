...
public final class AppUserData {
    ...
    public static AppUserData importInstance(Long officeId, Long staffId, String username, String firstname, String email,
            Boolean sendPasswordToEmail, Boolean passwordNeverExpires, List<Long> roleIds, Integer rowIndex) {
        return new AppUserData(officeId, staffId, username, firstname, email, sendPasswordToEmail, passwordNeverExpires, roleIds,
                rowIndex);
    }

    private AppUserData(Long officeId, Long staffId, String username, String firstname, String email,
            Boolean sendPasswordToEmail, Boolean passwordNeverExpires, List<Long> roleIds, Integer rowIndex) {
        this.id = null;
    ...
    public static AppUserData template(final AppUserData user, final Collection<OfficeData> officesForDropdown) {
        return new AppUserData(user.id, user.username, user.email, user.officeId, user.officeName, user.firstname,
    ...
    public static AppUserData template(final Collection<OfficeData> offices, final Collection<RoleData> availableRoles,
        ...
        return new AppUserData(null, null, null, null, null, null, availableRoles, selfServiceRoles,null, offices, null, null, null);
    }
    ...
    public static AppUserData instance(final Long id, final String username, final String email, final Long officeId,
            final String officeName, final String firstname, final Collection<RoleData> availableRoles,
        ...
        return new AppUserData(id, username, email, officeId, officeName, firstname, availableRoles, selfServiceRoles,
    ...
    private AppUserData(final Long id, final String username, final String email, final Long officeId, final String officeName,
            final String firstname, final Collection<RoleData> availableRoles,
