...
public class OfficeData implements Serializable {
    ...
    public static OfficeData importInstance(final String name, final Long parentId, final LocalDate openingDate, final String externalId,final String address) {
        return new OfficeData(null, name, null, externalId, openingDate, null, parentId, null, null,address);
    }
    ...
    public OfficeData(final Long id, final String name, final String nameDecorated, final String externalId, final LocalDate openingDate,
            final String hierarchy, final Long parentId, final String parentName, final Collection<OfficeData> allowedParents,String address) {
        this.id = id;
        this.name = name;
