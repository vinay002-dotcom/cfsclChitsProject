    ...
    private static final class OfficeMapper implements RowMapper<OfficeData> {
        ...
        public String officeSchema() {
            return " o.id as id, o.name as name, " + nameDecoratedBaseOnHierarchy
                    + " as nameDecorated, o.external_id as externalId, o.opening_date as openingDate,o.address as address, o.hierarchy as hierarchy, parent.id as parentId, parent.name as parentName "
